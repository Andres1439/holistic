  ...
  return (
    <div className="space-y-6">
      <div className="animate-fade-in">
        <h1 className="text-2xl sm:text-3xl font-bold text-black mb-2">Gestión de Campañas</h1>
        <p className="text-black/70">Ingresa y monitorea tus campañas publicitarias</p>
      </div>
        ...
        <Card className="bg-primary-light/20 border-blue-500/30 hover:bg-primary-light/30 transition-all duration-300">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-black">FACEBOOK ADS</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-primary-light/20 border-red-500/30 hover:bg-primary-light/30 transition-all duration-300">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-black">GOOGLE ADS</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-black mb-2">
        ...
        <Card className="bg-primary-light/20 border-pink-500/30 hover:bg-primary-light/30 transition-all duration-300">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-black">TIKTOK ADS</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-black mb-2">
