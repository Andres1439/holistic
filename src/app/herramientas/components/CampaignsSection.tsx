  ...
  return (
    <div className="space-y-6">
      <div className="animate-fade-in">
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Gestión de Campañas</h1>
        <p className="text-white/70">Ingresa y monitorea tus campañas publicitarias</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
        ...
        <Card className="bg-primary-medium/20 border-pink-500/30 hover:bg-primary-medium/30 transition-all duration-300">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3">
